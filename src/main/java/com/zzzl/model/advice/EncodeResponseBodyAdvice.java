...
import com.zzzl.model.annotation.AesSecurityParameter;
import com.zzzl.model.annotation.RsaSecurityParameter;
import com.zzzl.model.annotation.SecurityParameter;
import com.zzzl.model.utils.AesEncryptUtils;
import com.zzzl.model.utils.RSAUtils;
...
public class EncodeResponseBodyAdvice implements ResponseBodyAdvice {
    ...
    private Object encodeAes(MethodParameter methodParameter,Object body){
        ...
        try {
            ...
            ResultVo success = ResultVoUtil.success(requestData);
            return success;
        } catch (Exception e) {
            e.printStackTrace();
